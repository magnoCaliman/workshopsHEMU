...
- How can we recreate the example 2 from [[*3.3 EXAMPLE 2][item 3.3]] but now using variables that /describe the logic/ of how our sequence of frequencies? Is there more than one way of doing it?
