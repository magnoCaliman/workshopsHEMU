...
- How can we recreate the example 2 from [[https://github.com/magnoCaliman/workshopRAPP/blob/master/workshopRAPP_git.org#33-example-2][item 3.3]] but now using variables that /describe the logic/ of how our sequence of frequencies? Is there more than one way of doing it?
