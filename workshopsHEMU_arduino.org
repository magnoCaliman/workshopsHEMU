...
- If the installation was sucessfull you should now have a program called ~Arduino~ in your list of programs, which when opened looks like this. That means you are all set.
